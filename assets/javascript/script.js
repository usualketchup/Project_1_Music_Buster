$(document).ready(function() {
    ...
    $("#submit-button").on("click", function(event) {
        ...
        // build query URL according to which values are there

        // Check to see which values were blank
        // To determine which function to call
        // Call function with (url)
        // displayArtist(url)

        // Take functions out (scoping) and invoke functions within document.ready function 
                                                            ...
                                                            <div class="modal-card">
                                                                ...
                                                                <section class="modal-card-body content">
                                                                    ...
                                                                    <h1>Track Music Video:</h1><hr>
                                                                        <embed width="800" height="400" src="${mostLovedTrackList[i].strMusicVid}" frameborder="0" allowfullscreen></embed>
                                                                </section>
                                                            </div>
                                                        </div>`)
